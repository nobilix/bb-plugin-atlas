...
В разделе [Неймспейсы бэкенда](/ru/backend/) перечислены неймспейсы, которые разработчики пытаются угадать, но в bb их нет.
...
| slot | Точка регистрации в коде, `app.slots.*`. Их 22; полный список — во [фронтенд-API](/ru/frontend/) |
